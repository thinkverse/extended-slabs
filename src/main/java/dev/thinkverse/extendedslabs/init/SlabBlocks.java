    ...
    public static class Register {
        ...
        public static void RegisterSlabItemBlocks(final RegistryEvent.Register<Item> event) {
            final BlockItem[] items = {
                new BlockItem(BlockList.DIRT_SLAB, new Item.Properties().group(ExtendedSlabs.GROUP).maxStackSize(64)),
                new BlockItem(BlockList.GRASS_SLAB, new Item.Properties().group(ExtendedSlabs.GROUP).maxStackSize(64))
            };
